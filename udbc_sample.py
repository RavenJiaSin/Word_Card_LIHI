...
# 為user新增一卡牌
user_db.add_card_to_user(user_id = 4, voc_id='0_able')

# 查詢使用者有的卡牌資訊
print(user_db.get_card_info(user_id = 4, voc_id = '0_able'))

# 修改user的卡牌資料
# user_db.update_card_info(user_id = 4, voc_id = '0_able', correct_count = 1)
